...
- DETECCIÓN DE MANO (crítico): incluye SIEMPRE el campo booleano "esMano". Ponlo en true SOLO si el sujeto principal de la imagen es una PALMA o mano humana que se pueda leer (aunque esté algo borrosa, ladeada o parcial). Ponlo en false si el sujeto NO es una mano: una CARA o persona, un CELULAR o pantalla, un objeto, un animal, comida, un paisaje, texto, una habitación, etc. Regla práctica: si tuvieras que señalar la línea de la vida y NO hay una palma donde hacerlo, es false. Si "esMano" es false, NO inventes líneas ni consejos (deja "lineas" vacío).
