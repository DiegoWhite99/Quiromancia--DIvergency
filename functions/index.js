...
const QUIROMANCIA_ELEVENLABS_API_KEY = defineSecret('QUIROMANCIA_ELEVENLABS_API_KEY'); // voz del oráculo
...
exports.quiromanciaApi = onRequest(
  { region: 'us-central1', cors: true, timeoutSeconds: 60, memory: '512MiB',
    secrets: [QUIROMANCIA_OPENAI_API_KEY, QUIROMANCIA_ELEVENLABS_API_KEY, SMTP_USER, SMTP_PASS] },
  app
);
